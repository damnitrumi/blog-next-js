...
describe("<HtmlContent />", () => {
  ...
  it("should match snapshot", () => {
    ...
    expect(container.firstChild).toMatchInlineSnapshot(`
      ...
      .c0 pre[class*="language-"],.c0 code[class*="language-"] {
        color: #d4d4d4;
        font-size: 13px;
        text-shadow: none;
      ...
      .c0 pre[class*="language-"]::selection,.c0 code[class*="language-"]::selection,.c0 pre[class*="language-"] *::selection,.c0 code[class*="language-"] *::selection {
        text-shadow: none;
        background: #264f78;
      }
      ...
      .c0 pre[class*="language-javascript"],.c0 code[class*="language-javascript"],.c0 pre[class*="language-jsx"],.c0 code[class*="language-jsx"],.c0 pre[class*="language-typescript"],.c0 code[class*="language-typescript"],.c0 pre[class*="language-tsx"],.c0 code[class*="language-tsx"] {
        color: #9cdcfe;
      }

      .c0 pre[class*="language-css"],.c0 code[class*="language-css"] {
        color: #ce9178;
      }

      .c0 pre[class*="language-html"],.c0 code[class*="language-html"] {
        color: #d4d4d4;
      }
